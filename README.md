...
We also wanted to make the seasons as comparable as possible. We did this by dividing all the relevant metrics by their season's corresponding pace so that the increase in the speed of the game would not confuse the model. Additionally, instead of using games played as a factor, we used percentage of games played in. That way shortened seasons such as the 2020 season would not have very different games played figures.
